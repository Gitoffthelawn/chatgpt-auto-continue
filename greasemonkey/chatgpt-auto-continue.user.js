...
// @require             https://cdn.jsdelivr.net/gh/adamlui/chatgpt-auto-continue@71e0966/chromium/extension/components/modals.js#sha256-1hhigoYJDOpO1NzvnQXBYoc5dO/f7u1YirgDqe+oT40=
...
// @require             https://cdn.jsdelivr.net/gh/adamlui/chatgpt-auto-continue@f2b3f80/chromium/extension/lib/styles.js#sha256-E4fk+2jCwqqvifafmf+srDuw2fK+r8roty+5hxsj7sg=
// @require             https://cdn.jsdelivr.net/gh/adamlui/chatgpt-auto-continue@ced1efc/chromium/extension/lib/sync.js#sha256-kHyBNBjrIis02aaXoBokH+h3rBC5nuPRbwb+ci0noOg=
...
(async () => {
    ...
    window.gmToolbarMenu = {
        ...
        refresh() {
            ...
            this.entryIDs.forEach(GM_unregisterMenuCommand)
            this.register()
        },
        ...
        register() {
            ...
            : Object.keys(settings.controls).map(key => {
                ...
                return GM_registerMenuCommand(menuLabel, () => {
                    settings.save(key, !app.config[key]) ; sync.configToUI({ key })
        ...
        onload: ({ responseText }) => {
            ...
            if (app.latestVer)
                for (let i = 0 ; i < 4 ; i++) { // loop thru subver's
                    ...
                    else if (latestSubVer > currentSubVer) // outdated
